...
/***/ function(module, exports, __webpack_require__) {
	...
	var _httpAjax = __webpack_require__(7);
	...
	exports['default'] = {
	  duplicate: _arrayDuplicate2['default'],
	  addEventListener: _domAddEventListener2['default'],
	  getUrlParam: _domGetUrlParam2['default'],
	  parseHTML: _domParseHTML2['default'],
	  scrollTo: _domScrollTo2['default'],
	  ajax: _httpAjax2['default'],
	  classNames: _utilityClassNames2['default'],
	  timestamp: _utilityTimestamp2['default'],
	  userAgent: _utilityUserAgent2['default']
	};
