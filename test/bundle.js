	...
	describe('Array', function () {
	    ...
	    describe('isArray()', function () {
	        it('should return true when args is an Array', function () {
	            _utils2['default'].isArray([]).should.be['true']();
	            _utils2['default'].isArray([1, 2, 3]).should.be['true']();
	        });
	        it('should return false when args is not an Array', function () {
	            _utils2['default'].isArray(true).should.be['false']();
	            _utils2['default'].isArray({ name: [1, 2, 3] }).should.be['false']();
	            _utils2['default'].isArray(undefined).should.be['false']();
	            _utils2['default'].isArray(null).should.be['false']();
	            _utils2['default'].isArray(100).should.be['false']();
	        });
	    });
	});
